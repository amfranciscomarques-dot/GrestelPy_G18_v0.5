...
from ..financas import tesouraria_mensal as teso_mod
...
def build_balanco_mensal(
    ...
    if _df_t_m is None:
        _df_t_m = teso_mod.build_tesouraria_mensal(a, base, sched)
...
def build_dfc_mensal(
    ...
    df_t_m = teso_mod.build_tesouraria_mensal(a, base, sched)
...
def build_tesouraria_completa(
    ...
    df_teso = teso_mod.build_tesouraria_mensal(a, base, sched)
    fin_m = _financiamento_mensal(sched)
    cap_m = _capex_mensal(sched)
...
def build_rolling_forecast(
    ...
    df_t = teso_mod.build_tesouraria_mensal(a, base, sched)
