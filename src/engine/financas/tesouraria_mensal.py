...
from ..operacoes import vendas as vendas_mod
from ..operacoes import cmvmc as cmvmc_mod
from ..integracao import fse as fse_mod
from ..pessoal import pessoal as pessoal_mod
from ..integracao import eoep as eoep_mod
from ..statements import dr as stmt_mod
...
def _dist_sazonal_vn_weighted(
    ...
    """
    from .vendas import _saz_to_dict
