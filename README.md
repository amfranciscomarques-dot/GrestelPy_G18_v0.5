...
├── computed/schedules.yaml  ← outputs pré-calculados (NÃO editar)
...
- [ ] Pessoal mensal 2025 como output independente (`pessoal_mensal_2025`) — actualmente calculado inline em `tesouraria.py`
- [ ] CMVMC mensal 2025 como output independente (`cmvmc_mensal_2025`)
- [ ] `Schedules.juros_total` — verificar se a chave existe no `schedules.yaml` ou precisa de alias
...
### Testes
- [ ] Testes de regressão para os novos outputs mensais (`eoep_mensal_2025`, `dr_mensal_2025`, etc.)
- [ ] Teste de reconciliação: `sum(dr_mensal_2025.vn) == dr[ano==2025].vn`
- [ ] Teste: saldos EOEP 2025 no Balanço = derivados do calendário mensal

### M6 — Plano de Negócios (a partir de 2026-05-05)
...
*GrestelPy · Engine v0.5+ · PEF 2025-26 · Grupo G18 · ISCA-UA*
